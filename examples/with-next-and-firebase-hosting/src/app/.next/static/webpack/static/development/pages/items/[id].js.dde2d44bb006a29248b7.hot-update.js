...
const Index = () => {
  ...
  const [item, setItem] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(new _models_item__WEBPACK_IMPORTED_MODULE_3__["default"](id));
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    if (!item.snapshot) {
      Object(_babel_runtime_corejs2_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        const item = yield new _models_item__WEBPACK_IMPORTED_MODULE_3__["default"](id).fetch();
        console.log(item);
        setItem(item);
      })();
    }
...
//# sourceMappingURL=[id].js.dde2d44bb006a29248b7.hot-update.js.map